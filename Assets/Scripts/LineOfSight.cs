...
public class LineOfSight : MonoBehaviour
{
    ...
    void Awake()
    {
        ...
        getstoned = GameObject.FindGameObjectWithTag("PlayerMesh").GetComponent<GetStoned>();
        glowwarning = GameObject.FindGameObjectWithTag("PlayerMesh").GetComponent<GlowWarning>();
    }
